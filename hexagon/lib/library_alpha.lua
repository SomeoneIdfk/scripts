...
local library = {
	...
	settings = {
		guiname = "Hexagon",
		title = "Hexagon [SomeoneIdfk Edition] - Alpha",
		logo = "rbxassetid://1521636846", -- "http://www.roblox.com/asset/?id=1521636846",
		footer = "SomeoneIdfk Modified it -_-",
		modal = true,
    ...
    theme = {
        buttons = Color3.fromRGB(0, 255, 0), -- toggle, sliders colors
...
function library:SaveConfiguration()
    ...
    for i,v in pairs(library.pointers) do
		if not table.find({"SettingsTabCategoryPlayersUsername", "SettingsTabCategoryConfigsName"}, i) then
			tbl[i] = v.value
		end
	end
